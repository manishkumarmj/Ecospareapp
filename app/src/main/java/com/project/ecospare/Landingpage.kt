...
class Landingpage : AppCompatActivity() {
    ...
    private var currentIndex = 0 // Track the current index for images and headings
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        trade.setOnClickListener {
            val trade = Intent(this@Landingpage, Buy_sellpage::class.java)
            startActivity(trade)
        }
    ...
    // Helper function to update the content on screen based on the index
